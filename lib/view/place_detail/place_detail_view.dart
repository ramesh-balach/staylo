...
import '../../utils/components/star_rating.dart';
      ...
      child: Row(
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: widget.place['isActive'] == false ? Colors.grey : Colors.pink,
              borderRadius: BorderRadius.circular(15),
            ),
            child: Text(
              widget.place['isActive'] == false ? "Not Available" : 'Reserve',
              style: const TextStyle(
                fontSize: 18,
                color: Colors.white,
                fontWeight: FontWeight.bold,
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: IconButton(
                      ...
                      icon:  Icon(
                        provider.isExist(widget.place) ? Icons.favorite :
                        Icons.favorite_border,
                        color: provider.isExist(widget.place) ? Colors.red : Colors.black,
                        size: 20,
                      )),
                ),
              ],
